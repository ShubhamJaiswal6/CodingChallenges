...
public class BeautifulStringOperations {

	public static int makeBeautiful(String str) {
		int operations = 0;
		for (int i = 0; i < str.length(); i++) {
			if (i % 2 == Character.getNumericValue(str.charAt(i)) % 2) {
				operations++;
			}
		}
		return  Math.min(operations, str.length() - operations);
	}

	public static void main(String[] args) {
		String str1 = "0000";
        System.out.println(makeBeautiful(str1)); // Output: 1
	}
